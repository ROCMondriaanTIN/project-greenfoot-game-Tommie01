...
public class MyWorld extends World {
        ...
        if(Hero.isTouchingDoor == true){
            if(Hero.hasKey == true){
                if(level == 4){
                    ...
                    if(Hero.diamonds == 4){
                        addObject(new Text("Gefeliciteerd je hebt alle verborgen diamanten gevonden!" , Color.WHITE), 500, 770);
                    }
                    else if(Hero.diamonds > 0){
                        addObject(new Text("Gefeliciteerd je hebt " + Hero.diamonds + " diamanten gevonden, helaas hebt je er " 
                        + (4 - Hero.diamonds) + " gemist.", Color.WHITE), 500, 770);
                    }
                    else{
                        addObject(new Text("Helaas heb je geen verborgen diamanten gevonden, volgende keer beter!" , Color.WHITE), 500, 770);
                    }
                    if(Hero.diamonds > 0){
                    addObject(new DiamondBox(), 120, 650);
                }
                }
                else{
                    clearScreen();
    ...
    public void characterMenu(){
        ...
        addObject(new Text("Kies een personage:"), 150, 400);
    ...
    public void levelSelector(){
        ...
        addObject(new Text("Kies een level:"), 100, 500);
